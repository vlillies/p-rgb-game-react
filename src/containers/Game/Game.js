...
class App extends Component {
  ...
  gameWon() {
    ...
    this.setState(
      { tiles, gameWon: true, headerColor: this.state.targetColor },
      () => {
        setTimeout(() => {
  ...
  handleConfirm = () => {
    this.setState({ open: false, gameWon: false }, () =>
      this.initializeBoard()
    );
  };
  ...
  render() {
    return (
      <Container>
        ...
        />
        <ControlBar
          clicked={this.handleDifficultySelect}
